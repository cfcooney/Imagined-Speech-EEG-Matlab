%Name: Ciaran Cooney
%Date: 02/03/2018
%K-Nearest Neighbour Classifier using 5-fold cross-validation for EEG data

set = load('set_total_phm');
set.set_total_phm;

ClassNames = {'/n/';'/m/';'/piy/';'/uw/';'/diy/';'/tiy/';'/iy/';'knew';'gnaw';'pot';'pat'};
%ClassNames = {'knew';'gnaw';'pot';'pat'};
%ClassNames = {'/n/';'/m/';'/piy/';'/uw/';'/diy/';'/tiy/';'/iy/'};
...
for fold = 1:KFolds
    ...
    model = fitcknn(trainingPredictors, trainingResponse,'ClassNames',ClassNames);
